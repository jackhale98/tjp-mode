...
(declare-function tjp-toggle-structure "tjp-mode")
(declare-function tjp-toggle-critical-path "tjp-mode")
...
(defconst tjp-evil-localleader-bindings
  '(("c"   :group "compile")
    ...
    ("s"   :group "structure")
    ("s s" tjp-toggle-structure       "structure (toggle)")
    ("s c" tjp-toggle-critical-path   "critical path (toggle)")
